...
SOURCES = \
	__init__.py \
	wap_plugin.py wap_plugin_dialog.py

PLUGINNAME = wap_plugin

PY_FILES = \
	__init__.py \
	wap_plugin.py wap_plugin_dialog.py

UI_FILES = wap_plugin_dialog_base.ui
...
QGISDIR=C:\Users\fhfonsecaa\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
