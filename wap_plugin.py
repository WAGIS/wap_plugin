...
/***************************************************************************
 WAPlugin
                                 A QGIS plugin
 Provides access to all the WaPOR data and includes it in the QGIS canvas as another raster layer, providing WaPOR data easy access to the QGIS users.
 Moreover, the water accounting and productivity component of the plugin will help the water management, providing the opportunity of calculating water
 accounting indicators, through the creation of maps and reports.
...
class WAPlugin:
    ...
    def __init__(self, iface):
        ...
        # # Locations
        # self.locListContinental = ["Algeria","Angola","Benin","Botswana","Burkina Faso","Burundi",
        ...
        # self.locListSubNational = ["Awash, Ethiopia", "Bekaa, Lebanon", "Busia, Kenya",
        #         "Gezira, Sudan", "Koga, Ethiopia",
    ...
    def downloadCroppedRaster(self):
        ...
        params['dimensions'] = [{"code": self.dimension,
                                 "values": [self.member]}]
